...
if(isset($_POST['submit']))
{
    ...
    // إضافة رقم الهاتف في الاستعلام
    $query=mysqli_query($con, "insert into users(fullname,address,city,phone,gender,email,password) 
        values('$fname','$address','$city','$phone','$gender','$email','$password')");
    if($query)
    {
        echo "<script>alert('تم التسجيل بنجاح. يمكنك تسجيل الدخول الآن.');</script>";
    }
}
?>
<!DOCTYPE html>
            ...
            <div class="box-register">
                <form name="registration" id="registration" method="post">
                    <fieldset>
                        ...
                        <p>ادخل بياناتك الشخصية ادناه:</p>
                        ...
                        <p>ادخل تفاصيل حسابك أدناة:</p>
                        <div class="form-group">
                            <span class="input-icon">
                                <input type="email" class="form-control" name="email" id="email" onBlur="userAvailability()" placeholder="البريد الإلكتروني" required>
                        ...
                        <div class="form-group">
                            <div class="checkbox clip-check check-primary">
                                ...
                                <label for="agree">انا اوافق</label>
                            </div>
                        </div>
                        <div class="form-actions">
                            <p>
                                هل لديك حساب بالفعل؟
                                <a href="user-login.php">تسجيل الدخول</a>
                            </p>
                            <button type="submit" class="btn btn-primary pull-right" id="submit" name="submit">
                                انشاء <i class="fa fa-arrow-circle-right"></i>
                            </button>
                        </div>
                    </fieldset>
                </form>
