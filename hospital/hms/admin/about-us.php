...
$pagedes=$con->real_escape_string($_POST['pagedes']);
    ...
    echo '<script>alert("تم تحديث صفحة "حولنا".")</script>';
  }
  else
    {
...
<html lang="en">
	<head>
		<title>المسؤول | معلومات عنا </title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">المسؤول  | تحديث محتوى "حولنا"</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>المسؤول </span>
...
?>
                    ...
                    <?php } ?>
                    <button type="submit" class="btn btn-primary mr-2" name="submit">حفظ</button>
                  </form>
								</div>
							</div>
								</div>
