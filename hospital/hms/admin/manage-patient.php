    ...
    <head>
        ...
        <style>
            ...
            .page-item.active .page-link {
                ...
                color: #fff;
                box-shadow: 0 4px 10px rgba(52, 152, 219, .3)
            }
            ...
            <div class="main-content">
                <div class="container-fluid">
                    ...
                    <div class="stats-container">
                        ...
                        <div class="stat-card"><i class="fas fa-male text-info"></i>
                            <h3><?php echo $male_count; ?></h3>
                            <p>مرضى ذكور</p>
                        </div>
                        <div class="stat-card"><i class="fas fa-female text-warning"></i>
                            <h3><?php echo $female_count; ?></h3>
                            <p>مرضى إناث</p>
                        </div>
                        <div class="stat-card"><i class="fas fa-clock text-success"></i>
                                ...
                                <div class="pagination-container">
                                    ...
                                    <nav>
                                        <ul class="pagination">
                                            <?php if ($page > 1): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="?page=<?php echo $page - 1; ?>" aria-label="السابق">
                                            ...
                                            <?php if ($page < $total_pages): ?>
                                                <li class="page-item">
                                                    <a class="page-link" href="?page=<?php echo $page + 1; ?>" aria-label="التالي">
                                    ...
                                    <div class="page-jump">
                                        ...
                                        <select class="form-select" onchange="window.location.href='?page='+this.value">
                                            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                                <option value="<?php echo $i; ?>" <?php if ($i == $page) echo 'selected'; ?>>
                                                    <?php echo $i; ?>
                                                </option>
                                            <?php endfor; ?>
                                        </select>
