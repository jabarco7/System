		...
		<div class="rt-modal__dialog" role="dialog" aria-modal="true" aria-labelledby="rtModalTitle">
			...
			<div class="rt-modal__body">
				...
				<div id="pm-content" style="display:none;">
					<div class="row">
						<div class="col-sm-6">
							<div><span class="info-label">الاسم:</span> <span id="pName"></span></div>
						</div>
						<div class="col-sm-6">
							<div><span class="info-label">الجنس:</span> <span id="pGender" class="label"></span></div>
						</div>
						<div class="col-sm-6">
							<div><span class="info-label">الهاتف:</span> <span id="pPhone"></span></div>
						</div>
						<div class="col-sm-6">
							<div><span class="info-label">البريد:</span> <span id="pEmail" class="text-muted-dash"></span></div>
						</div>
						<div class="col-sm-12" style="margin-top:8px;">
							<div><span class="info-label">العنوان:</span> <span id="pAddress" class="text-muted-dash"></span></div>
						</div>
						<div class="col-sm-6" style="margin-top:8px;">
							<div><span class="info-label">تاريخ الإنشاء:</span> <span id="pCreated"></span></div>
						</div>
						<div class="col-sm-6" style="margin-top:8px;">
							<div><span class="info-label">آخر تعديل:</span> <span id="pUpdated"></span></div>
						</div>
					</div>
				</div>
			</div>
