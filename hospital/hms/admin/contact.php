...
$email=$_POST['email'];
 $mobnum=$_POST['mobnum'];
    ...
    echo '<script>alert("تم تحديث الاتصال بنا.")</script>';
  }
  else
    {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"> المسؤول  | تحديث محتوى الاتصال بنا</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>المسؤول </span>
									...
									<li class="active">
										<span>تحديث محتوى الاتصال بنا </span>
									</li>
								</ol>
							</div>
						</section>
...
?>
                    ...
                    <?php } ?>
                    <button type="submit" class="btn btn-primary mr-2" name="submit">تعديل</button>
                  </form>
								</div>
							</div>
								</div>
