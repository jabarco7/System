...
if($query){
echo "<script>alert('تم تحديث ملاحظة المسؤول بنجاح.');</script>";
...
<html lang="en">
	<head>
		<title>المسؤول | تفاصيل الاستعلام</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">المسؤول | تفاصيل الاستعلام</h1>
																	</div>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">إدارة <span class="text-bold">تفاصيل الاستعلام</span></h5>
												<hr />
...
<form name="query" method="post">
	<tr>
		...
		تعديل <i class="fa fa-arrow-circle-right"></i>
								</button>
