...
<head>
    ...
    <style>
        ...
        body{font-family:'Tajawal',sans-serif;background:#f0f5f9;color:#333;padding-top:24px}
        ...
        .app-header h1{margin:0;font-weight:700;font-size:1.2rem}
        .card-clean{background:#fff;border-radius:15px;padding:20px;box-shadow:0 5px 15px rgba(0,0,0,.06)}
    ...
    <div class="layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="profile-edit.php"><i class="fa-regular fa-id-card"></i><span>ملفي الطبي</span></a></li>
