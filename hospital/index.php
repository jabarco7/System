    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:30px; margin-top: 1% !important;">مستشفى عمران
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>تسجيل دخول المريض</h6>
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btn btn-success btn-sm">اضغط هنا</button>
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <section id="contact_us" class="contact-us-single">
        <div class="row no-margin">
            ...
            <div  class="col-sm-12 cop-ck">
                ...
                <h2 >نموذج الأتصال</h2>
                    <div class="row cf-ro">
                        <div  class="col-sm-3"><label>ادخل الأسم :</label></div>
                        <div class="col-sm-8"><input type="text" placeholder="ادخل الأسم" name="fullname" class="form-control input-sm" required ></div>
                    </div>
                    <div  class="row cf-ro">
                        <div  class="col-sm-3"><label>ادخل البريد الإلكتروني :</label></div>
                        <div class="col-sm-8"><input type="text" name="emailid" placeholder="ادخل البريد الإلكتروني" class="form-control input-sm"  required></div>
                    </div>
                     <div  class="row cf-ro">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        <li><a ui-sref="about" href="#about">من نحن</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="portfolio" href="#services">خدمات</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="products" href="#logins">تسجيلات الدخول</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="gallery" href="#gallery">معرض</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="contact" href="#contact">اتصل بنا</a><i class="fa fa-angle-right"></i></li>
                    </ul>
                </div>
